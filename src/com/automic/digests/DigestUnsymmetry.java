...
public class DigestUnsymmetry {
	...
	public static void main(String[] args) {
		...
		System.out.println("原文:" + CommonUtil.byte2HexStr(mess.getBytes(), true));
		byte[] enbts = ds.encryptor(mess.getBytes());
		System.out.println("密文:" + CommonUtil.byte2HexStr(enbts, true));
		System.out.println("解密:" + CommonUtil.byte2HexStr(ds.decryptor(enbts), true));
